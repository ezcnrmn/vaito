...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/listings": {
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 25,
                        "description": "Количество объявлений на страницу",
                        "name": "size",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.PaginatedListingResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные нового объявления",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateListingPayload"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ListingResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateListingPayload"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.AuthenticateUserPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/moderation/listings/{id}/activate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/moderation/listings/{id}/deactivate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateUserPayload"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateUserPasswordPayload"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "handler.AuthenticateUserPayload": {
            "type": "object",
            "required": [
                "email",
                "password"
        ...
        "handler.CreateListingPayload": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Полный комплект: Зарядное устройство. Коробка. Наушники. Чехол в подарок."
                },
                "price": {
                    "type": "integer",
                    "minimum": 1,
        ...
        "handler.PaginatedListingResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "handler.UpdateUserPasswordPayload": {
            "type": "object",
            "required": [
                "password"
            ],
